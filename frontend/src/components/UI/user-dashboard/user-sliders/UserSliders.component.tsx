...
// Mảng chứa các đường dẫn hình ảnh cho slider
const images = [
...
// Định nghĩa kiểu dữ liệu cho các props của slider
interface UserSlidersProps {
    interval?: number; // Thời gian giữa các lượt chuyển đổi (tính bằng mili-giây)
}
...
const UserSliders: React.FC<UserSlidersProps> = ({ interval = 5000 }) => {
    ...
    // Sử dụng useEffect để tự động chuyển đổi hình ảnh sau mỗi khoảng thời gian
    useEffect(() => {
    ...
    return (
        <div className="image-slider">
            {/* Duyệt qua mảng hình ảnh và hiển thị từng hình ảnh */}
